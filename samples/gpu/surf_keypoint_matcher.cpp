...
int main(int argc, char* argv[])
{
    ...
    GpuMat keypoints1GPU, ***REDACTED***;
    GpuMat descriptors1GPU, descriptors2GPU;
    surf(img1, GpuMat(), keypoints1GPU, descriptors1GPU);
    surf(img2, GpuMat(), ***REDACTED***, descriptors2GPU);
    
    cout << "FOUND " << keypoints1GPU.cols << " keypoints on first image" << endl;
    cout << "FOUND " << ***REDACTED***.cols << " keypoints on second image" << endl;
    ...
    SURF_GPU::downloadKeypoints(***REDACTED***, keypoints2);
