/* $Id: tif_win32.c,v ***REDACTED-IP*** 2010-06-08 18:50:43 bfriesen Exp $ */
 ...
 * Scott Wagner (***REDACTED-EMAIL***), Itek Graphix, Rochester, NY USA
 */
#include "tiffiop.h"
...
/*
 * From "Hermann Josef Hill" <***REDACTED-EMAIL***>:
 *
