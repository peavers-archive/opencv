...
/* JPEG Compression support, as per the original TIFF 6.0 specification.
   ...
   Murchison of Oceana Matrix Ltd. <***REDACTED-EMAIL***> to support lossless Huffman
   ...
   Contributed by Scott Marovich <***REDACTED-EMAIL***> with considerable help
   from Charles Auer <***REDACTED-EMAIL***> to unravel the mysteries of image files
...
+  * advice: Scott B. Marovich <***REDACTED-EMAIL***>, Hewlett-Packard Labs, 6/01.
+  */
+ GLOBAL(void)
...
#   define td (&tif->tif_dir)
     ...
     */
     ...
     /* BEWARE OF KLUDGE:  According to Charles Auer <***REDACTED-EMAIL***>, if our
