...
#
# Created: 30 Dec 2010 by Vladimir Dudnik (***REDACTED-EMAIL***)
#

set(IPP_FOUND)
set(IPP_VERSION_STR "***REDACTED-IP***") # will not detect earlier versions
...
if(NOT IPP_FOUND)
    ...
    foreach(curdir ${CMAKE_SYSTEM_PREFIX_PATH})
        ...
        if(EXISTS ${curdir})
            ...
            # init IPP_LATEST_VERSION  version with oldest detectable version (***REDACTED-IP***)
