...
.. |opencv_android_bin_pack| replace:: OpenCV-***REDACTED-IP***-android-sdk.zip
.. _opencv_android_bin_pack_url: http://sourceforge.net/projects/opencvlibrary/files/opencv-android/2.4.3/OpenCV-***REDACTED-IP***-android-sdk.zip/download
