...
::
    ...
    OpenCV-***REDACTED-IP***-android-sdk
    |_ apk
...
#. Unpack the SDK archive into the chosen directory.
   ...
   .. code-block:: bash
      ...
      unzip ~/Downloads/OpenCV-***REDACTED-IP***-android-sdk.zip

.. |opencv_android_bin_pack| replace:: :file:`OpenCV-***REDACTED-IP***-android-sdk.zip`
.. _opencv_android_bin_pack_url: http://sourceforge.net/projects/opencvlibrary/files/opencv-android/***REDACTED-IP***/OpenCV-***REDACTED-IP***-android-sdk.zip/download
