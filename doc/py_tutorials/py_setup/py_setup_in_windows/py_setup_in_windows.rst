...
4. Download latest OpenCV release from `sourceforge site <http://sourceforge.net/projects/opencvlibrary/files/opencv-win/2.4.6/OpenCV-***REDACTED-IP***.exe/download>`_ and double-click to extract it.
...
1. Download and install Visual Studio and CMake.
    ...
    1.2. `CMake <http://www.cmake.org/files/v2.8/cmake-***REDACTED-IP***-win32-x86.exe>`_
